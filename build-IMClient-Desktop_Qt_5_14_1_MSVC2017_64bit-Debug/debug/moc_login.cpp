...
#include <memory>
#include "../../IMClient/src/login/login.h"
...
QT_MOC_LITERAL(3, 14, 12), // "RecvLoginAck"
QT_MOC_LITERAL(4, 27, 5), // "char*"
QT_MOC_LITERAL(5, 33, 8) // "pPackage"

    },
    "CLogin\0Login\0\0RecvLoginAck\0char*\0"
    "pPackage"
};
...
void CLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->RecvLoginAck((*reinterpret_cast< char*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
...
QT_INIT_METAOBJECT const QMetaObject CLogin::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_CLogin.data,
    qt_meta_data_CLogin,
    qt_static_metacall,
    nullptr,
    nullptr
